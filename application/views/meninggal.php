    ...
    <section class="content">
        <div class="row mt-2">
            ...
            <div class="col-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"> Data Karyawan Meninggal</h3>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered" id="tableMeninggal">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                foreach ($karyawan_meninggal as $km) { ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        <td><a href="karyawan/detail/<?= $km->uid ?>" class="detail"><?php echo $km->npk ?></a></td>
                                        </td>
                                        <td><?= $km->nama ?></td>
                                        <td><?= $km->department ?></td>
                                        <td>
                                            ...
                                            if ($km->tanggal == "0000-00-00") {
                                                echo "-";
                                            } else {
                                                echo date('d-m-Y', strtotime($km->tanggal));
                                            }
                                            ?>
                                        </td>
                                    </tr>
