    ...
    <section class="content">
        <div class="row mt-2">
            ...
            <div class="col-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"> Data Karyawan Resign</h3>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered" id="tableResign">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                foreach ($karyawan_resign as $key) { ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        <td><a href="karyawan/detail/<?= $key->uid ?>" class="detail"><?php echo $key->npk ?></a></td>
                                        </td>
                                        <td><?= $key->nama ?></td>
                                        ...
                                        <td>
                                            ...
                                            if ($key->tanggal == "0000-00-00") {
                                                ...
                                                echo date('d-m-Y', strtotime($key->tanggal));
                                            }
                                            ?>
                                        </td>
                                    </tr>
