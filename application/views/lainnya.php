    ...
    <section class="content">
        <div class="row mt-2">
            ...
            <div class="col-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"> Data Karyawan Non-Aktif (Lainnya)</h3>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered" id="tableLainnya">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                foreach ($karyawan_lainnya as $kl) { ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        <td><a href="karyawan/detail/<?= $kl->uid ?>" class="detail"><?php echo $kl->npk ?></a></td>
                                        </td>
                                        <td><?= $kl->nama ?></td>
                                        <td><?= $kl->department ?></td>
                                        <td>
                                            ...
                                            if ($kl->tanggal == "0000-00-00") {
                                                echo "-";
                                            } else {
                                                echo date('d-m-Y', strtotime($kl->tanggal));
                                            }
                                            ?>
                                        </td>
                                    </tr>
